...
module.exports = (reporter, definition) => {
  ...
  if (reporter.compilation) {
    reporter.compilation.resource('diff.css', path.join(__dirname, '../static', 'diff.css'))
  }

  if (reporter.execution) {
    diff2htmlStyle = reporter.execution.resource('diff.css').toString()
  }

  diff2htmlStyle = diff2htmlStyle || fs.readFileSync(path.join(__dirname, '../static/diff.css')).toString()
